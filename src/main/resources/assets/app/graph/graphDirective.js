myApp.directive('ghVisualization', function () {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.$watch('val', function (newVal, oldVal) {
                ...
                var layers = $scope.vis.selectAll("g.layer")
                    .data(data)
                    .enter().append("g")
                ...
                var labels = $scope.vis.selectAll("text.label")
                    .data(data[0])
                    .enter().append("text")
                    .attr("class", "label")
                    .attr("x", x)
                ...
                var keyText = $scope.vis.selectAll("text.key")
                    .data(data)
                    .enter().append("text")
                    .attr("class", "key")
                    .attr("y", function (d, i) {
                ...
                var keySwatches = $scope.vis.selectAll("rect.swatch")
                    .data(data)
                    .enter().append("rect")
                    .attr("class", "swatch")
                    .attr("width", 20)
                ...
                function transitionGroup() {
                    $scope.vis.selectAll("g.layer rect")
                        .transition()
                        .duration(500)
